...
<article {{ $attributes->merge(['class' => 'card-premium flex flex-col p-6 sm:p-8']) }}>
    ...
    <blockquote class="mt-4 flex-1 text-sm leading-relaxed text-slate-600 sm:text-base [overflow-wrap:anywhere]">"{{ $quote }}"</blockquote>
    <footer class="mt-6 flex items-center gap-3 border-t border-slate-100 pt-6">
        ...
        <div>
            <cite class="not-italic text-sm font-semibold text-navy">{{ $author }}</cite>
